...
def Calculators():
  whichCalc = input("Which calculator would you like to use? (1) Weight Calculator (2) Area Calculator. Or would you like to (3) Quit ")
  if whichCalc == "1":
    weightCalc()
  elif whichCalc == "2":
    areaCalc()
...
input(f"{green}{underline}Enter your choice with its corresponding number:{end} ")
